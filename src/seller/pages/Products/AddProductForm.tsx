          ...
          <Grid item xs={12} sm={6} lg={3}>
            ...
            >
              ...
              {formik.touched.color && formik.errors.color && (
                ...
                <FormHelperText> {Array.isArray(formik.errors.color) ? formik.errors.color.join(", ") : formik.errors.color as string}</FormHelperText>
              )}
            </FormControl>  
          </Grid>
          <Grid item xs={12} sm={6} lg={3}>
            ...
            >
              ...
              {formik.touched.sizes && formik.errors.sizes && (
                ...
                <FormHelperText>{Array.isArray(formik.errors.sizes) ? formik.errors.sizes.join(", "): formik.errors.sizes as string}</FormHelperText>
          ...
          <Grid item xs={12} sm={6} lg={4}>
            ...
            >
              ...
              {formik.touched.category && formik.errors.category && (
                <FormHelperText>{Array.isArray(formik.errors.category) ? formik.errors.category.join(", ") : formik.errors.category as string}</FormHelperText>
              )}
            </FormControl>
          </Grid>
